<template>
  <div>
    <v-card color="#ffffff" class="myCard">
      <v-card-title class="headline">快餐店设计 - 一级</v-card-title>
      <v-card-subtitle>
        <form>
          <v-row>
    ...
    <v-card color="#ffffff" class="myCard">
      <v-card-title class="headline">快餐店设计 - 二级</v-card-title>
      <v-card-subtitle>
        <form>
          <v-row>
    ...
    <v-card color="#ffffff" class="myCard">
      <v-card-title class="headline">快餐店设计 - 三级</v-card-title>
      <v-card-subtitle>
        <form>
          <v-row>
...
export default {
  ...
  created () {
    const that = this
    console.log(this)
    this.$http.get('http://47.101.146.28:7003/game2d/vstationstore/getVStationStoreTypeInfoById?id=2')
